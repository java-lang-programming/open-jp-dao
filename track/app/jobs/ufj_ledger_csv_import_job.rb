class UfjLedgerCsvImportJob < ApplicationJob
  queue_as :csv
  ...
  def perform(import_file_id:)
    ...
    begin
      ...
      # CSVインポート処理
      ufj_import_file = FileUploads::Ledgers::UfjImportFile.new(import_file: import_file)

      # オブジェクトの生成
      ledgers = ufj_import_file.generate_ledgers
