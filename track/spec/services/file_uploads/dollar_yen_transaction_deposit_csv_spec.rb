  ...
  describe 'deposit?' do
    ...
    context 'unique_keys_errors' do
      ...
      it 'should empty array unique_keys_errors.' do
        ...
        csv = Files::DollarYenTransactionDepositCsv.new(address_id: addresses_eth.id, row_num: 2, row: row)
        h = csv.unique_key_hash(unique_key_hash: h)
        csv = Files::DollarYenTransactionDepositCsv.new(address_id: addresses_eth.id, row_num: 4, row: row2)
        h = csv.unique_key_hash(unique_key_hash: h)
    ...
    context 'make_dollar_yen_transactions' do
      ...
      it 'should get dollar_yen_transactions.' do
        transaction_type1
        service = FileUploads::DollarYenTransactionDepositCsv.new(address_id: addresses_eth.id, file: deposit_three_csv_path)
